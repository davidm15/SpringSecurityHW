...
public class EmployeeManagerController {
	...
	public String fillEmployeeList() {
		...
		employeeManager.addEmployee(new EmployeeModel(1, "Max", "Mustermann", now, (float) 4000));
		employeeManager.addEmployee(new EmployeeModel(2, "Mario", "Rossi", now, (float) 4000));
		employeeManager.addEmployee(new EmployeeModel(3, "John", "Doe", now,(float) 4000));
		employeeManager.addEmployee(new EmployeeModel(4, "Jane", "Doe", now,(float) 4000));
		employeeManager.addEmployee(new EmployeeModel(5, "Maria", "Noname", now,(float) 4000));
		employeeManager.addEmployee(new EmployeeModel(6, "Josef", "Noname", now,(float) 4000));
